...
style_image = imageio.imread("images/Sunrise.jpg")
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = 1 / ( 4 * (n_C * n_H * n_W) ** 2) * tf.reduce_sum((tf.subtract(GS, GG)) ** 2)
...
content_image = imageio.imread("images/4.jpg")
content_image = reshape_and_normalize_image(content_image)

style_image = imageio.imread("images/CompositionVII.jpg")
style_image = reshape_and_normalize_image(style_image)


#generated_image = generate_noise_image(content_image)
generated_image = imageio.imread('images/input.jpg')
...
def model_nn(sess, input_image, num_iterations=600):
    ...
    for i in range(num_iterations):
        ...
        if i % 20 == 0:
            ...
            save_image("output/" + str(i // 20 + 30) + ".png", generated_image)
